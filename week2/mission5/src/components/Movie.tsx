...
const Movie = ({ movie }: MovieProps) => {
  ...
  return (
    <div className="relative group w-[150px] h-[225px] cursor-pointer">
      <img
        className="w-full h-full object-cover rounded-md group-hover:blur-sm transition duration-300"
